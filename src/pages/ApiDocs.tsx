    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Comprehensive API reference for carbon emission and offset
            management
          </p>
        </div>
        <Dialog>
              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      This endpoint is rate limited to 1000 requests per hour
                      per API key.
                    </p>
                  </div>
                </div>
                    ...
                    {selectedEndpoint.parameters.map((param, index) => (
                      <div key={index} className="border rounded-lg p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Description for the {param} parameter. This parameter
                          is used to filter or specify data.
                        </p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-muted rounded-lg p-4">
                      <code className="text-sm">
                        ...
                        &nbsp;&nbsp;"https://api.emissionlab.com
                        {selectedEndpoint.endpoint}" \<br />
                  ...
                  <div>
                    ...
                    <div className="bg-muted rounded-lg p-4">
                      <code className="text-sm">
                        ...
                        fetch('https://api.emissionlab.com
                        {selectedEndpoint.endpoint}', {`{`}
                        <br />
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-carbon-700">
              {apiEndpoints.length}
            </div>
