                  ...
                  {selectedPayment.payment_type === "subscription" ? (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm mt-1 font-medium">
                          {selectedPayment.subscription_details?.plan_name ||
                            "N/A"}
                        </p>
                        <p className="text-xs text-gray-500">
                          {selectedPayment.subscription_details
                          ...
                          >
                            {selectedPayment.subscription_details?.status
                              ? selectedPayment.subscription_details.status
                                  .charAt(0)
                                  .toUpperCase() +
                                selectedPayment.subscription_details.status.slice(
                                  1
                                )
                              : "N/A"}
                          </Badge>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm mt-1 font-medium">
                          {selectedPayment.carbon_offset_details
                            ?.project_name || "N/A"}
                        </p>
                      </div>
                      <div>
